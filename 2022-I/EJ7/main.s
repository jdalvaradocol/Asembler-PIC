...
DISPLAY:    MOVWF   DATO_DIS
	    ...
	    RETLW   0x40	    ; el numero es igual a 0 retorna con W = 0xBF
	    ...
	    XORWF   DATO_DIS,W	    ; Se realiza la operacion W = DATO_DIS XOR W
	    BTFSC   STATUS,Z	    ; Se evalua el estado del bit Z del registro STATUS
	    RETLW   0x79	    ; el numero es igual a 1 retorna con W = 0x86
	    ...
	    XORWF   DATO_DIS,W	    ; Se realiza la operacion W = DATO_DIS XOR W
	    BTFSC   STATUS,Z	    ; Se evalua el estado del bit Z del registro STATUS
	    RETLW   0x24	    ; el numero es igual a 1 retorna con W = 0xDB
	    ...
	    XORWF   DATO_DIS,W	    ; Se realiza la operacion W = DATO_DIS XOR W
	    BTFSC   STATUS,Z	    ; Se evalua el estado del bit Z del registro STATUS
	    RETLW   0x30	    ; el numero es igual a 1 retorna con W = 0xCF
	    ...
	    XORWF   DATO_DIS,W	    ; Se realiza la operacion W = DATO_DIS XOR W
	    BTFSC   STATUS,Z	    ; Se evalua el estado del bit Z del registro STATUS
	    RETLW   0x19	    ; el numero es igual a 1 retorna con W = 0xE6
	    ...
	    XORWF   DATO_DIS,W	    ; Se realiza la operacion W = DATO_DIS XOR W
	    BTFSC   STATUS,Z	    ; Se evalua el estado del bit Z del registro STATUS
	    RETLW   0x12	    ; el numero es igual a 1 retorna con W = 0xED
	    ...
	    XORWF   DATO_DIS,W	    ; Se realiza la operacion W = DATO_DIS XOR W
	    BTFSC   STATUS,Z	    ; Se evalua el estado del bit Z del registro STATUS
	    RETLW   0x02	    ; el numero es igual a 1 retorna con W = 0xFD
	    ...
	    XORWF   DATO_DIS,W	    ; Se realiza la operacion W = DATO_DIS XOR W
	    BTFSC   STATUS,Z	    ; Se evalua el estado del bit Z del registro STATUS
	    RETLW   0x78	    ; el numero es igual a 1 retorna con W = 0x87
	    ...
	    XORWF   DATO_DIS,W	    ; Se realiza la operacion W = DATO_DIS XOR W
	    BTFSC   STATUS,Z	    ; Se evalua el estado del bit Z del registro STATUS
	    RETLW   0x00	    ; el numero es igual a 1 retorna con W = 0xFF
	    ...
	    XORWF   DATO_DIS,W	    ; Se realiza la operacion W = DATO_DIS XOR W
	    BTFSC   STATUS,Z	    ; Se evalua el estado del bit Z del registro STATUS
	    RETLW   0x10	    ; el numero es igual a 1 retorna con W = 0xEF
	    RETLW   0xFF	    ; el numero no esta entre 0 y 9 retorna con W = 0x00
...
DELAY:	    MOVLW   255		   ; Se asigna W = 255							    "1uS"
...
LOOPj:	    MOVLW   255		   ; Se asigna W = 255							    1us
